# -*- coding: utf-8 -*-
"""
Created on Thu Nov 26 17:24:33 2020
...
# Visualizar codo de division de K-means
...
plt.scatter(kmeans.cluster_centers_[:,0], kmeans.cluster_centers_[:,1], s = 150, c = "gray", label = "Baricentros")
